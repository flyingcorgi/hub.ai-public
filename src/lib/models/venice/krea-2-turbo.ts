...
/**
 * Krea 2 Turbo (Text to Image, uncensored) via Venice.ai
 ...
 */
export const venice_krea_2_turbo: Model = {
  name: "Krea 2 Turbo (Venice)",
  id: "venice/krea-2-turbo",
  mediaType: "image",
  costEstimate: "$0.04 / image (1K), $0.06 (2K)",
  inputSchema: [
    {
      key: "prompt",
      type: "string",
      required: true,
      description: "The positive prompt for the generation (up to 5000 characters).",
    },
    {
      key: "negative_prompt",
      type: "string",
