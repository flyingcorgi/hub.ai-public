 ...
 * Faster, lower-cost image-to-video model for cinematic multi-shot videos with AI camera
 * control and consistent characters across scenes.
 * Endpoint: https://api.wavespeed.ai/api/v3/bytedance/seedance-2.0-mini/image-to-video
 */
export const wavespeed_seedance_2_mini_i2v: Model = {
  name: "Seedance 2.0 Mini I2V (WaveSpeed)",
